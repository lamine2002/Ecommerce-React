    ...
    return(
        <>
            <Typography sx={{display: { xs: 'none', md: 'flex' }}} >
                <div style={{width: "100%", height: "650px", backgroundImage: "url(/asset/image5.jpg)", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}}>
            ...
            <Container sx={{display: { xs: 'flex', md: 'none' }}}>
                <video style={{width:"100%", height:"100%"}} autoPlay loop muted>
                    <source src="/asset/diaporama/slideVideo.mp4" type="video/mp4" />
                </video>
            </Container>
        </>
    )
